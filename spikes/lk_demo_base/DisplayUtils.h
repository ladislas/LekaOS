...
{
  public:
	const std::array<const char *, 51> image_table = {
		"leka-logo",
		...
		"emotion-happiness-leka",
		"emotion-sadness-leka",
		"emotion-anger-leka",
		"emotion-fear-leka",
		"emotion-disgust-leka",
	};

	const std::array<const char *, 8> emotion_table = {
		"robot-emotion-happy",	   "robot-emotion-angry", "robot-emotion-affraid",	   "robot-emotion-disgusted",
		"robot-emotion-sad_tears", "robot-emotion-sad",	  "robot-emotion-tired_tears", "robot-emotion-neutral"};

	const std::array<const char *, 3> video_table = {"animation-idle", "animation-joy", "animation-perplexity"};
